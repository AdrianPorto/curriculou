      ...
      <div className="flex flex-1 h-[100vh] w-screen    justify-center">
        ...
        >
          <div className="flex flex-1   justify-center">
            <div className="w-28 h-28 bg-black rounded-full mt-10"></div>
          </div>
          ...
          <div className="flex flex-row">
            ...
            <div className="flex flex-col">
              <div className=" w-[323px] mt-12 h-[486px] ">
                <div className="flex  font-bold text-sm mb-6" id="titulo">
                  Sobre
                </div>
                <div className="flex flex-row">
                ...
                <textarea
                  className="text-[12px] pl-8 w-[100%] h-32 overflow-y-hidden   border-l-2 border-gray-500"
                  placeholder=""
                  aria-disabled
                ></textarea>
              </div>
